...
<div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
          ...
          <br><p class="pageheader-title">Complete Programs</p>
          </div>
        </div>
      </div>
<style> 
...
<div class="row">
    <div class="col-lg-12">
        ...
        <?php 
          ...
          $sql="SELECT * FROM dn where status>0 and year='".$from_date."' and month='".$to_date."'";
          ...
          while($row = mysqli_fetch_assoc($result)) {
                ...
                <a class="dropdown-item" href="dn_view.php?dn_id=<?php echo $ap_id ?>">View</a>
                <a class="dropdown-item" href="dn_download.php?dn_id=<?php echo $ap_id ?>">Download</a>
