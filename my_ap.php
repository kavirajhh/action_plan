...
<div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
          ...
          <br><h4 class="pageheader-title"> My Advance Programs</h4>
          <div class="item">
            <?php  
...
<div class="row">
    <div class="col-lg-12">
        ...
        <?php 
          ...
          $sql="SELECT * FROM ap where nic='".$s_cOde."' ";
          ...
          while($row = mysqli_fetch_assoc($result)) {
                ...
                <?php 
                if($status!=2){  echo "<a class=dropdown-item href=ap_add.php?ap_id=$ap_id >Add</a>";
                                echo "<a class=dropdown-item href=ap_com.php?ap_id=$ap_id >Complete</a>";
                               ?>
