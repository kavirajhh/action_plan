...
<div class="row">
    ...
    <?php 
          ...
          $sql="SELECT * FROM dn where status='1' ";
          ...
          while($row = mysqli_fetch_assoc($result)) {
                ...
                <a class="dropdown-item" href="dn_approve.php?dn_id=<?php echo $ap_id  ?>"><i class="fa fa-check"></i> Approve</a>
                <a class="dropdown-item" href="dn_reject.php?dn_id=<?php echo $ap_id  ?>"><i class="fa fa-remove"></i> Reject</a>
                <a class="dropdown-item" href="dn_view.php?dn_id=<?php echo $ap_id ?>"><i class="fa fa-user-times"></i> View</a>
                              </div>
                </div>
