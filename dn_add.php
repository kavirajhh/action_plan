...
<div class="row">
 ...
 <form action="dn_add_up.php" method="post" enctype="multipart/form-data" style="width: 100%">
...
<div class="row">
    ...
    <tbody>
      ...
      <tr>
          ...
          <a class="dropdown-item" href="dn_del_task.php?id=<?php echo $id  ?>" onclick="return confirm('Delete Task?')"><i class="fa fa-del"></i> Delete</a>
          <a class="dropdown-item" href="dn_task_edit.php?id=<?php echo $id  ?>"><i class="fa fa-del"></i> Edit</a>
          </div>
          </div>
