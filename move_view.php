...
<div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
          ...
          <br><h4 class="pageheader-title">My Field Visits</h4>
          </div>
        </div>
      </div>
<style> 
...
<div class="row">
    <div class="col-lg-12">
        ...
        <tr><th>Date </th><th>Departure time</th><th>Return time</th><th>Location</th><th>Description</th><th>Distance</th><th>Status</th><th class="datatable-nosort">Action</th></tr>
        </thead>
        ...
        <?php 
          ...
          $sql="SELECT * FROM move where nic='".$s_cOde."' and f_date like '".$month."%'  ";
          ...
          while($row = mysqli_fetch_assoc($result)) {
               ...
               // $des=desname_id($conn,$des_id);
                ...
                echo "<tr><td>$f_date</td><td>$f_out</td><td>$f_back</td><td>$f_loc</td><td>$f_des</td><td>$f_dis (km)</td><td>$st_name</td>";
               ...
               <?php 
               if($f_status==2){
                 echo "<a class=dropdown-item href=move_return.php?f_id=$f_id>Return Time</a>";
                }
                ?>
