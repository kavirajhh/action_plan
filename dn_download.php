<title><center>Complete Program </center></title>
<?php
    ...
    if((!isset($_SESSION['s_cOde'])))
      {
        ...
        $app_by=dn_app_by($conn,$dn_id);
        $app_date=dn_app_date($conn,$dn_id);
        $year=dn_year($conn,$dn_id);
        $month=dn_month($conn,$dn_id);
                    ...
                    <table id="loadData1" class="table table-striped table-bordered table-hover display" ><!-- table table-striped table-bordered table-hover begin -->
                        <thead>
                            <tr>
                                ...
                                <th><?php echo "CP Month <br> $year/$month" ?></th>
                                <th><?php echo "CP status <br> $app" ?></th>
                                <th><?php echo "Officer <br> $uname <br>$des $remark" ?></th>
                                <th><?php echo "CP No <br> $dn_id" ?></th>
